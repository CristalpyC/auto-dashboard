...
export const Intro = () => {
  ...
  return (
    <>
      <Menu>
        <button onClick={() => router.push('/login')} className="text-md w-[8rem] bg-[#6393DB] p-1 shadow-sm ease-in-out hover:scale-105 hover:bg-[#649cf1aa]">
          Login
        </button>
      </Menu>
      <div className="p-11 flex-col lg:flex-row md:flex-row flex justify-center items-center lg:justify-between md:justify-between">
        <div className="mt-5 lg:mt-24 md:mt-24 text-center lg:text-left md:text-left">
          ...
          <button className="text-[4vmin] md:text-[3vmin] lg:text-[3vmin] md:w-[15rem] lg:w-[18rem] mt-8 text-white  bg-[#6393DB] p-2 shadow-md ease-in-out hover:scale-105 hover:bg-[#547bb5aa]">
            Create your account
          </button>
        </div>
