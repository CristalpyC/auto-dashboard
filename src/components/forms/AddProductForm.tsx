    ...
    <Formik
        ...
        onSubmit={async (values, { resetForm }) => {
            ...
            try{
              ...
              toast.error("Couldn't add the product", { duration: 2500 });

            } finally{
              setLoading(false);
              toast.success("The product has been added", { duration: 2500 });
            }
        }}
    >
        {/* Form component */}
        <Form className='flex flex-col justify-center items-center'>
            ...
            <Button className="w-[100%] bg-blue-500 hover:bg-blue-700">
              Add product
